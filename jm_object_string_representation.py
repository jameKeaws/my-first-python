...
class Person():
    ...
    def __repr__(self):
        return f"<Overrode repr Person Class - fname:{self.fname}, lname:{self.lname}, age:{self.age}>"
        
    # TODO: use str for a more human-readable string
    def __str__(self):
        return f"Overrode str in Person class {self.fname} {self.lname} is {self.age}"
